...
<span>Status : </span><textarea style="height:60px; width:265px;" name="note"><?php echo $row['note'];?></textarea><br>
<span>Payment Mode : </span><textarea style="height:60px; width:265px;" name="note"><?php echo $row['paymentmode'];?></textarea><br>
<span>Vehcile number : </span><input type="text" style="width:265px; height:30px;" name="memno" value="<?php echo $row['vehcileno']; ?>" /><br>
<span>RTO number : </span><textarea style="height:60px; width:265px;" name="note"><?php echo $row['rto'];?></textarea><br>

<span>DOCUMENTS : </span><textarea style="height:60px; width:265px;" name="note"><?php echo $row['documents'];?></textarea><br>
