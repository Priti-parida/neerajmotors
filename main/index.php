...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="attaindence.php"><i class="icon-group icon-2x"></i> Employee Details</a>                                    </li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>NEERAJ MOTORS</center></font>
<div id="mainmain">



<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br> Sales</a>  
<a href="purchases.php"><i class="icon-shopping-cart icon-2x"></i><br> Purchases</a>               
...
<a href="sales_inventory.php"><i class="icon-group icon-2x"></i><br> Product Inventory</a>
<a href="attaindence.php"><i class="icon-group icon-2x"></i><br>Employee Details</a>     
