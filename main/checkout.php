...
<div id="ac">
<center><h4><i class="icon icon-money icon-large"></i> Neeraj motors</h4></center><hr>
...
<center>
<input type="text" size="25" value="" name="cname" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="COMPANY NAME/CLIENT NAME" style="width: 268px; height:30px;" />
